...
<head>
  ...
  <link rel="stylesheet" href="<?= SITE_URL ?>views/styles/register.css">
</head>
<body class="hero-bg min-h-screen flex flex-col">
  ...
  <nav class="flex items-center justify-between px-8 py-6">
    ...
    <a href="<?= SITE_URL ?>index.php?action=getFormLogin" class="text-sm border border-white/50 text-white px-5 py-2 hover:bg-white hover:text-[#1a1610] transition-all duration-300">
      Iniciar sesión
    </a>
  </nav>
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-12">
    <div class="animate-fade-up delay-1 w-full max-w-md bg-[#faf8f4]/95 backdrop-blur-md p-8 shadow-2xl">
      ...
      <!-- Form -->
      <form id="registerForm" action="<?= SITE_URL ?>index.php?action=getFormCreateUser" method="POST" class="space-y-5">
        ...
        <div>
          ...
          <div id="error-tipo_documento_id"></div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-3 border border-[#e8ddc9] bg-transparent text-sm text-[#1a1610] placeholder-[#c4a97d] focus:border-[#c4a97d] transition-colors duration-200"
          />
          <div id="error-numero_documento"></div>
        </div>
        ...
        <div class="relative">
          ...
          <input
            ...
            type="password"
            placeholder="••••••••"
            class="w-full px-4 py-3 pr-12 border border-[#e8ddc9] bg-transparent text-sm text-[#1a1610] placeholder-[#c4a97d] focus:border-[#c4a97d] transition-colors duration-200"
          />
          <button
            type="button"
        ...
        <button
          type="submit"
          class="w-full bg-[#1a1610] text-white py-3 text-sm tracking-widest uppercase hover:bg-[#3d3422] transition-colors duration-200 mt-6"
        >
          Crear cuenta
        </button>
      ...
      <p class="text-center text-xs text-[#b08f5f] mt-6">
        ¿Ya tienes cuenta?
        <a href="<?= SITE_URL ?>index.php?action=getFormLogin" class="underline underline-offset-4 hover:text-[#1a1610] transition-colors duration-200">
          Inicia sesión
        </a>
      </p>
